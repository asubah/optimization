...
def ts_nearest_neighbour_single(i, m):
    best_cost = maxsize
    best_tour = None
...
def ts_1100(m, tour, best_cost):
    ...
    min_cost = m_copy.min()
    min_index = np.where(m_copy == min_cost)
    min_edge = ((min_index[0][0], min_index[1][0]), min_cost)

    neighbours1 = tu.get_neighbour_nodes(tour, min_index[0][0])
    neighbours2 = tu.get_neighbour_nodes(tour, min_index[1][0])
    # print(neighbours1)
    # print(neighbours2)
...
def ts_1010(m, tour, best_cost):
    ...
    min_cost = m_copy.min()
    min_index = np.where(m_copy == min_cost)
    min_edge1 = ((min_index[0][0], min_index[1][0]), min_cost)

    neighbours = tu.get_neighbour_nodes(tour, min_index[0][0])
    neighbours += tu.get_neighbour_nodes(tour, min_index[1][0])
